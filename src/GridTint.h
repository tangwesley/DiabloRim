...
//
//  TWO TABLES, AND NEITHER IS THE PROVIDER ONE. The host keeps ONE provider
//  slot -- badges, tooltip lines and drop routing all ride it -- and a socket
//  mod may already hold it. Tinter and Annotator are separate slots with
//  separate handshakes, so colouring items and annotating them costs nobody
//  else their badges.
//
